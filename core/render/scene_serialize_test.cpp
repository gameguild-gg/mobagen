...
// under node:
//   em++ -std=c++20 core/render/scene_serialize_test.cpp -I core/ecs -I core/scene \
//        -I core/render -I <glm-include> -o build/serialize_test.js && node build/serialize_test.js
...
int main() {
    ...
    v.source.id = 7;
    v.source.width = 96; v.source.height = 96; v.source.depth = 96;
    ...
    std::printf("scene_serialize round-trip OK: %zu bytes, 2 entities, "
