...
Why this exists:
  ...
  - The renderer still wants stable paths such as assets/volume.raw and
    assets/volume.mvol, so this tool materializes those paths on demand.
...
MANIFEST_PATH = ROOT / "assets" / "assets.json"
