...
//
//   volume_io_test [dir]      (default dir: assets/dicom)
...
int main(int argc, char** argv) {
    const char* dir = argc > 1 ? argv[1] : "assets/dicom";
    ...
    const std::size_t c =
        (static_cast<std::size_t>(v.depth / 2) * v.height + v.height / 2) * v.width + v.width / 2;
