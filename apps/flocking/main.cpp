...
int main(int, char**) {
  ...
  SDL_Window* window = SDL_CreateWindow("Flocking", wgpu_surface_width, wgpu_surface_height, SDL_WINDOW_RESIZABLE);
  if (!window) {
  ...
  FlockingManager manager(world, sched);
  manager.Start();
  SDL_Log("Flocking Started");
