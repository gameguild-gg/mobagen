...
int main(int, char**) {
  ...
  SDL_Window* window = SDL_CreateWindow("Scenario", wgpu_surface_width, wgpu_surface_height, SDL_WINDOW_RESIZABLE);
  if (!window) {
